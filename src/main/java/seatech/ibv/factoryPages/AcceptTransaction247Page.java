...
//
//public class AcceptTransaction247Page extends BasePage {
//    public AcceptTransaction247Page(WebDriver driver) {
//        super(driver);
//    }
//
//    @FindBy(id = "moduleTree_1_switch")
//    private WebElement enterExpandButtonTransaction;
//    @FindBy(id = "moduleTree_4_a")
//    private WebElement expandTrans247;
//
...
//        actions.moveToElement(expandTrans247).click().perform();
//    }
...
//        myElement.click();
//    }
//    public void acceptTrans247(String methodAuthen, String valueDeviceAuthen) throws InterruptedException{
//        changeIframeLeft();
...
//        clickBtnSubmit();
//    }
//    public void btnContinued() {
//    	btnContinues.click();
//    }
//    public void continuesAcceptTrans247(String otp){
//        enterOtp(otp);
//        btnContinues.click();
//    }
//    public void warning() {
//    	if(txtWarning.isDisplayed()) {
//    		System.out.println(driver.findElement(By.name("dse_processorState")).getAttribute("value"));
//    		driver.quit();
//    	}
//    }
//}